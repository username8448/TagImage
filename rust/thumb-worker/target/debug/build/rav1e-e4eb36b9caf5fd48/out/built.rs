...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.95.0 (59807616e 2026-04-14) (Arch Linux rust 1:1.95.0-1)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.95.0 (59807616e 2026-04-14) (Arch Linux rust 1:1.95.0-1)";
#[allow(clippy::needless_raw_string_hashes)]
